...
void hal_mock_set_lid_closed(bool closed);
void hal_mock_set_lock_engaged(bool engaged);
void hal_mock_set_release_button(bool pressed);
...
bool      hal_mock_lock_hold_open_last(void);
int       hal_mock_lock_hold_open_count(void);
